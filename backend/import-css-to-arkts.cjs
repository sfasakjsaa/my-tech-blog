...
// 分类ID：🌽 TS到ArkTS适配规则
const categoryId = '1768000001014';
...
// 删除之前导入的 TS到ArkTS适配规则 题目（categoryId: 1768000001014）
...
console.log(`\n已删除之前导入的 TS到ArkTS适配规则 题目`);
console.log(`成功导入 ${newQuestions.length} 道题目到 "🌽 TS到ArkTS适配规则" 分类！`);
