...
# CSS题目重新导入脚本 - 导入到正确的分类
# 使用方法: bash scripts/import-css-questions-fixed.sh

BASE_URL="http://localhost:5000/api/proxy"
CATEGORY_ID="1768000001002"  # 🍈 CSS 分类的正确ID

echo "=== 重新导入CSS题目到正确的分类 ==="
...
# 2. 添加题目
echo ""
echo "开始添加题目到分类 🍈 CSS ($CATEGORY_ID)..."
